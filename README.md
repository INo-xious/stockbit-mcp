...
| `broker_distribution` | Broker-to-broker flow matrix: for each top broker, WHICH brokers were on the other side and how much moved. Requires a Stockbit balance of Rp 10,000,000. |
